...
| `GET /version`  | Returns app version, name, and author    |
...
```bash
cosign verify \
  --certificate-identity-regexp="https://github.com/kubeboiii/sigstore-app/.github/workflows/.*" \
  --certificate-oidc-issuer="https://token.actions.githubusercontent.com" \
  docker.io/himanshubtc/sigstore-app:main-<sha>
```
...
- GitOps repo: [github.com/kubeboiii/sigstore-gitops](https://github.com/kubeboiii/sigstore-gitops)
- Docker Hub: [hub.docker.com/r/himanshubtc/sigstore-app](https://hub.docker.com/r/himanshubtc/sigstore-app)
